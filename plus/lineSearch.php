...
$channeltype = (isset($channeltype) && is_numeric($channeltype)) ? $channeltype : 17;
...
$sp = new LineSearchView($typeid,$keyword,$orderby,$channeltype,$searchtype,$starttime,$pagesize,$kwtype,$mid);
$keyword = $oldkeyword;
$sp->Display();
