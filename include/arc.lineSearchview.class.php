 ...
 * 搜索视图类
 *
 * @version        $Id: arc.lineSearchview.class.php 1 15:26 2010年7月7日Z tianya $
...
class LineSearchView
{
    ...
    //php4构造函数
    function LineSearchView($typeid,$keyword,$orderby,$achanneltype="all",
    $searchtype="",$starttime=0,$upagesize=20,$kwtype=1,$mid=0)
    {
     ...
     * @return    string
     */
    function GetArcList($aimPlace, $prices, $startDate, $endDate, $days)
    {
